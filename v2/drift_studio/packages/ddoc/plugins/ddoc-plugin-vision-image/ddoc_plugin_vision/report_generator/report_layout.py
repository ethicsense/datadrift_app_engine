    ...
    for sample in samples_data:
        sample_rows.append(f"""
            <tr>
                ...
                <td style="padding: 8px; border-bottom: 1px solid #dee2e6;">{sample['estimated_noise_sigma']}</td>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 15px 0; border-radius: 5px; overflow: hidden; background: white;">
            <thead>
                <tr>
                    ...
                    <th style="background: #6c757d; color: white; padding: 10px; text-align: left;">Estimated Noise Sigma</th>
...
def generate_detailed_statistics_section(summary_data, quality_chart=None):
    ...
    <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; border: 1px solid #e9ecef;">
        <h4 style="color: #6c757d; margin: 0 0 10px 0;">📊 Estimated Noise Sigma Statistics</h4>
